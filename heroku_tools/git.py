...
def get_editor():
    ...
    """
    git_editor_config = 'git config --get core.editor'
    git_editor = sarge.capture_stdout(git_editor_config).stdout.text.strip()
    editor = SETTINGS.get('editor') or git_editor
